...
<html>
	...
	<head>
		...
		<script src="js/myjs/updateAddress.js" type="text/javascript"></script>
		<!-- //js -->
		<!-- cart -->
	...
	<body>
		...
		<div class="account">
			<div class="container">
				<div class="register">
					<form>
						<input id="address_id" type="hidden" value="<%=request.getParameter("address_id")%>">
						<div class="register-top-grid" align="center">
							...
							<div class="input">
								...
								<input class="myinput" type="text" name="telephone" id="telephone">
							</div>

							<div class="input">
								<span>邮编<label>*</label></span>
								<input class="myinput"  name="postcode" id="postcode">
							</div>
							<div class="input">
								<span>地址内容<label>*</label></span>
								<input class="myinput"  name="address_content" id="address_content">
							</div>
					...
					<div class="register-but">
						<div align="center">
							<input id="update" type="button" value="提交">
							<div class="clearfix"> </div>
						</div>
					</div>
				</div>
