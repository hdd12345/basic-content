...
<html>
	...
	<body>
					...
					<form>
						<div class="register-top-grid" align="center">
							...
							<div class="input">
								...
								<input class="myinput" type="text" name="email" id="email">
							</div>
							...
							<div class="input">
								...
								<div id="raio-box" align="center">
									<input type="radio" name="sex" value="男" checked> 男
									<input type="radio" name="sex" value="女"> 女
								</div>
							</div>
							<div class="input" align="center">
								请输入验证码*：<input id="validateCode" type="text"> 
								<div id="translate" style="display: inline-block;">
									<img src="http://localhost:8080/cakeshop/user/validateCode.jpg">
								</div>
							</div>
		...
		<input type="text" id="activeCode" placeholder="请输入激活码"><br>
